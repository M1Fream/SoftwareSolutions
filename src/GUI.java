...
public class GUI extends JFrame{
	private static ClosingDialog cd;
	private static BackgroundPanel bp;
	private static SignoutPanel signoutPanel;
	...
	public void main(){
			...
			Dimension d = new Dimension(guiWidth,guiLength-300); //Make dimension
			...
			//Add PromPanel
			signoutPanel = new SignoutPanel(this);
			p2.add(signoutPanel,BorderLayout.NORTH);
			...
			cd = new ClosingDialog(this);
			this.getRootPane().setDefaultButton(signoutPanel.getSubmitButton());
	}
	...
	public ClosingDialog getClosingDialog(){
		return cd;
	}
