...
public class SortingDialog extends JDialog implements PropertyChangeListener{
	 private JOptionPane optionPane;

	 //Strings to be used in optionPane
	 private String btnString1 = " Yes ";
	 private String btnString2 = " No ";
	 private String msgString1 = " Would you like to sort the data by last name, \n ID, or grade, instead of chronological order? ";
	   
	 private GUI myGUI;
	
	 public SortingDialog(GUI gui){
		//Set font
    ...
    public void propertyChange(PropertyChangeEvent e) {
    	...
    	if (isVisible() && (e.getSource() == optionPane) && (JOptionPane.VALUE_PROPERTY.equals(prop) || JOptionPane.INPUT_VALUE_PROPERTY.equals(prop))) {
            ...
            if(value == btnString1){ //If user selected "Yes"
        		SortingChoiceDialog scd = new SortingChoiceDialog(myGUI,this);
            	this.setVisible(false);
        	}else if(value == btnString2){ //If user selected "No"
        		closeProgram(); //Close program and keep sorted in chronological order
        	}
    	}
